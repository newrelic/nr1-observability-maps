...
import { Modal, Button, Form, Input, Label, Select } from "semantic-ui-react";
...
export default class ManageIcons extends React.PureComponent {
    ...
    writeIconSet() {
        let { name, green, orange, red, selected } = this.state;
        let documentId = selected == "new" || name != "" ? name : selected;
    ...
    render() {
        ...
        return (
            <Modal
                ...
                trigger={<Button icon="edit" content="Icons" className="filter-button" />}
            >
                ...
                <Modal.Content>
                    ...
                    <Form.Group widths={"16"}>
                        ...
                        <Label
                            style={{
                                display:
                                    (selected == "new" && name == "") || (selected == "" && name == "" ? "" : "none")
                            }}
                            color="red"
                            pointing
                        >
                        ...
                        <Form.Input
                            ...
                            value={green}
                            onChange={(e, d) => this.setState({ green: e.target.value })}
                        />
                        <Label style={{ display: isValidUrl(green) ? "none" : "" }} color="red" pointing>
                        ...
                        <Form.Input
                            ...
                            value={orange}
                            onChange={(e, d) => this.setState({ orange: e.target.value })}
                        />
                        <Label style={{ display: isValidUrl(orange) ? "none" : "" }} color="red" pointing>
                            Please enter a valid URL
                        </Label>
                        <br />
                        <Form.Input
                            ...
                            value={red}
                            onChange={(e, d) => this.setState({ red: e.target.value })}
                        />
                        <Label style={{ display: isValidUrl(red) ? "none" : "" }} color="red" pointing>
                            Please enter a valid URL
                        </Label>
                        <br />
                    </Form.Group>
                ...
                <Modal.Actions>
                    <Button
                        ...
                        positive
                        disabled={
                            (selected == "new" && name == "") || (selected == "" && name == "") || !isValidUrl(green)
                        }
