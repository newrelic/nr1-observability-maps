        ...
        if (data.hoverType == "customNrql" && data.hoverData && data.hoverData.length > 0) {
            ...
            if (data.apmSummary) {
                ...
                if (data.browserSummary.pageLoadTimeAverage)
                    metrics.push({ value: data.browserSummary.pageLoadTimeAverage, unit: "ms", name: "page latency" });
                ...
                if (data.browserSummary.jsErrorRate)
                    metrics.push({ value: data.browserSummary.jsErrorRate, unit: "%", name: "js errors" });
            }
        }
